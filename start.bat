...
echo ================================================
echo   myPeople - starting everything
echo ================================================
echo.
...
taskkill /F /FI "WINDOWTITLE eq myPeople Backend*" >nul 2>&1
taskkill /F /FI "WINDOWTITLE eq myPeople Admin*"   >nul 2>&1
taskkill /F /FI "WINDOWTITLE eq myPeople App*"     >nul 2>&1
...
pushd backend
start "myPeople Backend" cmd /k npm run start:dev
popd

pushd admin
start "myPeople Admin" cmd /k npm run dev
popd

pushd app
start "myPeople App" cmd /k npm run start
popd
