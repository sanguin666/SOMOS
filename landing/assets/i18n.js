...
(function () {
  var TRANSLATIONS = {
    es: {
      ...
      heroCtaPrimary: "Descubrir ANSAE", heroCtaSecondary: "Tengo un código QR",
      ...
      congPara: "Texto grande y contrastado, zonas táctiles amplias, sin gestos complicados — ANSAE está pensado para una comunidad mayormente mayor, sin dejar a nadie fuera.",
      ...
      footerCopyright: "© 2026 ANSAE. Página de demostración de un proyecto en desarrollo.",
      ...
      joinPara: "Descarga la app ANSAE para terminar de unirte a tu comunidad. Una vez instalada, ábrela y escanea de nuevo el mismo código QR — o introduce el código a mano más abajo.",
    ...
    en: {
      ...
      heroCtaPrimary: "Discover ANSAE", heroCtaSecondary: "I have a QR code",
      ...
      congPara: "Large, high-contrast text, big touch targets, no complicated gestures — ANSAE is built with a mostly older congregation in mind, without leaving anyone out.",
      ...
      footerCopyright: "© 2026 ANSAE. This is a demo landing page for a project in development.",
      ...
      joinPara: "Download the ANSAE app to finish joining your community. Once installed, open it and scan the same QR code again — or enter the code below by hand.",
    ...
    fr: {
      ...
      heroCtaPrimary: "Découvrir ANSAE", heroCtaSecondary: "J'ai un code QR",
      ...
      congPara: "Texte large et contrasté, grandes zones tactiles, aucun geste compliqué — ANSAE est pensé pour une communauté en grande partie plus âgée, sans laisser personne de côté.",
      ...
      footerCopyright: "© 2026 ANSAE. Page de démonstration pour un projet en développement.",
      ...
      joinPara: "Téléchargez l'app ANSAE pour terminer de rejoindre votre communauté. Une fois installée, ouvrez-la et scannez à nouveau le même code QR — ou saisissez le code ci-dessous à la main.",
  ...
  var STORAGE_KEY = "ansae-landing-language";
