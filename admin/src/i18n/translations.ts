...
const en: Translations = {
  ...
  qr: {
    ...
    defaultSubtext: 'Get the SOMOS app and stay connected with our parish — announcements, events, prayer requests, and more.',
    save: 'Save',
    saving: 'Saving…',
    saveError: 'Could not save your changes.',
...
const es: Translations = {
  ...
  qr: {
    ...
    defaultSubtext: 'Obtén la app SOMOS y mantente conectado con nuestra parroquia: anuncios, eventos, peticiones de oración y más.',
    save: 'Guardar',
    saving: 'Guardando…',
    saveError: 'No se pudieron guardar los cambios.',
...
const fr: Translations = {
  ...
  qr: {
    ...
    defaultSubtext: "Téléchargez l'app SOMOS et restez connecté à notre paroisse : annonces, événements, intentions de prière, et plus encore.",
    save: 'Enregistrer',
    saving: 'Enregistrement…',
    saveError: 'Impossible d’enregistrer les modifications.',
